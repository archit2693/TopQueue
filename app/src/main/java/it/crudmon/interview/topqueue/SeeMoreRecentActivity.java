...
public class SeeMoreRecentActivity extends AppCompatActivity implements SearchView.OnQueryTextListener{
...
//        FontManager.markAsIconContainer(findViewById(R.id.icons_container), iconFont);
        ...
        im1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(v.getContext(), "hii", Toast.LENGTH_LONG).show();
...
//                });
    ...
    public void dataQAnswer()
    {
        ...
        String q,a,c;
        for (int j = 0; j < recentarrayList.size() ; j++)
        {
            // Log.d("topic:",response.body().hot.recentList.get(j).topic_name);
            String name = recentarrayList.get(j).topic_name;
            String s=pref.getName();
            Log.d("msg",name);
            if (name.equals(s))
            {
                for (int i = 0; i < recentarrayList.get(j).questionlist.size(); i++)
                {
                    q = recentarrayList.get(j).questionlist.get(i).question;
                    a = recentarrayList.get(j).questionlist.get(i).answer;
                    c = recentarrayList.get(j).questionlist.get(i).code;
//                    q = "Question " +(i + 1) + " : " + q;
//                    a = "Answer:   " + a;
//                    c = "Code:   " + c;
